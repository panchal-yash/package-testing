...
echo "----------------$region has $servers running since past $days Days-----------------" >> OUTPUT
checkec2 "$region" "$days"  >> OUTPUT
echo "-------------------------------------------------------------------------------------"  >> OUTPUT


echo "Region $region has $servers running servers since past $days" >> overview
